...
-- Note by NexR --
  This HTTP library is borrowed from the standard library of Python 2.5 with a
  small extension that enables specifying connection timeout.  This is actually
  done in Python 2.6, but we have to deploy on Python 2.5 environments now.
  (See http://mail.python.org/pipermail/python-dev/2007-February/070897.html)
